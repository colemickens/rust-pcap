...
use pcapfe::{EthernetHeader,Ipv4Header,UdpHeader};
...
fn test_decode_tcp_packet() {
    ...
    match pkt {
        TcpPacket(eth_hdr, ip_hdr,  tcp_hdr,  payload) => {
            ...
            assert_eq!(tcp_hdr.Options, ~[0x00, 0x00, 0x00]);
...
fn test_encode_udp() {
    ...
    /*
    /home/cole/Code/rustpkgs/colemickens/pcapfe/test.rs:133:20: 133:32 error: unresolved name `Ethertype_IP`.
    /home/cole/Code/rustpkgs/colemickens/pcapfe/test.rs:133         Ethertype: Ethertype_IP,
                                                                                ^~~~~~~~~~~~
    /home/cole/Code/rustpkgs/colemickens/pcapfe/test.rs:148:23: 148:35 error: unresolved name `UserDatagram`.
    /home/cole/Code/rustpkgs/colemickens/pcapfe/test.rs:148         Protocol:     UserDatagram,
                                                                                  ^~~~~~~~~~~~
    */
    ...
    ip_hdr.Checksum = 0x8f37;
    udp_hdr.Checksum = 0x0c9d9;

    //let raw_bytes = ehdr.as_bytes().append(ihdr.as_bytes().append(thdr.as_bytes()));

    //assert_eq!(raw_bytes, expected);
    assert_eq!("implemented", "not implemented");
}
